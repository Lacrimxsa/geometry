...
// configuration step. It creates a namespace called `geometry`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", geometry::cmake::project_name, geometry::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", geometry::cmake::project_version);
      return EXIT_SUCCESS;
    }
